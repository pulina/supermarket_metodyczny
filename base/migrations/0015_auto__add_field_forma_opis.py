...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forma.opis'
        db.add_column(u'base_forma', 'opis',
                      self.gf('django.db.models.fields.TextField')(default='Brak'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forma.opis'
        db.delete_column(u'base_forma', 'opis')
