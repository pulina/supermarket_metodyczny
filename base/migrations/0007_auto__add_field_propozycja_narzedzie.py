...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Propozycja.narzedzie'
        db.add_column(u'base_propozycja', 'narzedzie',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['base.Narzedzia']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Propozycja.narzedzie'
        db.delete_column(u'base_propozycja', 'narzedzie_id')
