...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Propozycja.polymorphic_ctype'
        db.add_column(u'base_propozycja', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_base.propozycja_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Propozycja.polymorphic_ctype'
        db.delete_column(u'base_propozycja', 'polymorphic_ctype_id')
