...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Propozycja.druzyna'
        db.alter_column(u'base_propozycja', 'druzyna', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Propozycja.druzyna'
        db.alter_column(u'base_propozycja', 'druzyna', self.gf('django.db.models.fields.CharField')(default=2, max_length=200))
