...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pomysl.zgodnosc_z_metoda2'
        db.add_column(u'base_pomysl', 'zgodnosc_z_metoda2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pomysl.zgodnosc_z_metoda2'
        db.delete_column(u'base_pomysl', 'zgodnosc_z_metoda2')
