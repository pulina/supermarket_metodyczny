...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm.Pomysl.objects.iterator():
            obj.zgodnosc_z_metoda2 = obj.zgodnosc_z_metoda == 'True'
            obj.save(update_fields=['zgodnosc_z_metoda2'])

    def backwards(self, orm):
        for obj in orm.Pomysl.objects.iterator():
            obj.zgodnosc_z_metoda = str(obj.zgodnosc_z_metoda2)
            obj.save(update_fields=['zgodnosc_z_metoda'])
    ...
    models = {
        ...
        u'base.pomysl': {
            ...
            'zgodnosc_z_metoda2': ('django.db.models.fields.BooleanField', [], {})
        },
        u'base.tradycja': {
