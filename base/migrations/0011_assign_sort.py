...
class Migration(DataMigration):
    ...
    def prepare(self, orm):
        # South haven't frozen generic relation. Reapply it.
        gr = generic.GenericRelation('generic_positions.ObjectPosition')
        gr.contribute_to_class(orm.Okres, 'generic_position')

    def forwards(self, orm):
        "Write your forwards methods here."
        self.prepare(orm)
        for obj in orm.Okres.objects.iterator():
            obj.sort_order = obj.generic_position.all()[0].position
    ...
    def backwards(self, orm):
        ...
        self.prepare(orm)
        for obj in orm.Okres.objects.iterator():
            gp = obj.generic_position.all()[0]
            gp.position = obj.sort_order + 1
            gp.save()
