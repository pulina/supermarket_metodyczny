...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Komentarz.pomysl'
        db.delete_column(u'base_komentarz', 'pomysl_id')

        # Adding field 'Komentarz.propozycja'
        db.add_column(u'base_komentarz', 'propozycja',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['base.Propozycja']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Komentarz.pomysl'
        db.add_column(u'base_komentarz', 'pomysl',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['base.Pomysl']),
                      keep_default=False)

        # Deleting field 'Komentarz.propozycja'
        db.delete_column(u'base_komentarz', 'propozycja_id')
