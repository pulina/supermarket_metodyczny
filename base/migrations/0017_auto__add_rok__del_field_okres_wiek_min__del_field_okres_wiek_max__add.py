...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Okres.wiek_min'
        db.delete_column(u'base_okres', 'wiek_min')

        # Deleting field 'Okres.wiek_max'
        db.delete_column(u'base_okres', 'wiek_max')

        # Adding field 'Okres.rok'
        db.add_column(u'base_okres', 'rok',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['base.Rok']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Okres.wiek_min'
        db.add_column(u'base_okres', 'wiek_min',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Okres.wiek_max'
        db.add_column(u'base_okres', 'wiek_max',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'Okres.rok'
        db.delete_column(u'base_okres', 'rok_id')
