...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pomysl.zaakceptowany'
        db.delete_column(u'base_pomysl', 'zaakceptowany')

        # Adding field 'Propozycja.zaakceptowany'
        db.add_column(u'base_propozycja', 'zaakceptowany',
                      self.gf('django.db.models.fields.BooleanField')(default=2),
                      keep_default=False)

        # Adding field 'Narzedzia.zaakceptowany'
        db.add_column(u'base_narzedzia', 'zaakceptowany',
                      self.gf('django.db.models.fields.BooleanField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pomysl.zaakceptowany'
        db.add_column(u'base_pomysl', 'zaakceptowany',
                      self.gf('django.db.models.fields.BooleanField')(default=2),
                      keep_default=False)

        # Deleting field 'Propozycja.zaakceptowany'
        db.delete_column(u'base_propozycja', 'zaakceptowany')

        # Deleting field 'Narzedzia.zaakceptowany'
        db.delete_column(u'base_narzedzia', 'zaakceptowany')
