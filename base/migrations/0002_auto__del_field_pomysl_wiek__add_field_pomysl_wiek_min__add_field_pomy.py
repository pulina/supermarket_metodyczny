...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pomysl.wiek'
        db.delete_column(u'base_pomysl', 'wiek')

        # Adding field 'Pomysl.wiek_min'
        db.add_column(u'base_pomysl', 'wiek_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Pomysl.wiek_max'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Pomysl.wiek'
        raise RuntimeError("Cannot reverse this migration. 'Pomysl.wiek' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Pomysl.wiek'
        db.add_column(u'base_pomysl', 'wiek',
