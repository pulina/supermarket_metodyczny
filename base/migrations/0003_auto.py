...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field forma on 'Pomysl'
        m2m_table_name = db.shorten_name(u'base_pomysl_forma')
        ...
        db.create_unique(m2m_table_name, ['pomysl_id', 'forma_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field forma on 'Pomysl'
        db.delete_table(db.shorten_name(u'base_pomysl_forma'))
