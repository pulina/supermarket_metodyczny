...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pomysl.zgodnosc_z_metoda'
        db.alter_column(u'base_pomysl', 'zgodnosc_z_metoda', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'Pomysl.zgodnosc_z_metoda'
        db.alter_column(u'base_pomysl', 'zgodnosc_z_metoda', self.gf('django.db.models.fields.CharField')(max_length=3))
