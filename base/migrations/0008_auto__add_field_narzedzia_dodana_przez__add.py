...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Narzedzia.dodana_przez'
        db.add_column(u'base_narzedzia', 'dodana_przez',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Narzedzia._autor'
        db.add_column(u'base_narzedzia', '_autor',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Narzedzia.dodana_przez'
        db.delete_column(u'base_narzedzia', 'dodana_przez_id')

        # Deleting field 'Narzedzia._autor'
        db.delete_column(u'base_narzedzia', '_autor')
