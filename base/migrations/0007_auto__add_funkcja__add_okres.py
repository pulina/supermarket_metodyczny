...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Funkcja'
        db.create_table(u'base_funkcja', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nazwa', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'base', ['Funkcja'])
        ...
        db.create_table(u'base_okres', (
            ...
            ('wiek_min', self.gf('django.db.models.fields.IntegerField')()),
            ('wiek_max', self.gf('django.db.models.fields.IntegerField')()),
            ('stopien', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('funkcja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Funkcja'])),
        ))
        db.send_create_signal(u'base', ['Okres'])

        # Adding M2M table for field forma on 'Okres'
        m2m_table_name = db.shorten_name(u'base_okres_forma')
        ...
        db.create_unique(m2m_table_name, ['okres_id', 'forma_id'])


    def backwards(self, orm):
        # Deleting model 'Funkcja'
        db.delete_table(u'base_funkcja')

        # Deleting model 'Okres'
        db.delete_table(u'base_okres')

        # Removing M2M table for field forma on 'Okres'
        db.delete_table(db.shorten_name(u'base_okres_forma'))
    ...
    models = {
        ...
        u'base.okres': {
            ...
            'funkcja': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Funkcja']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nazwa': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'opis': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
